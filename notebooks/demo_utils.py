...
- If no base IRI is provided by the user, use <urn:rdflib_reasoning:> for minted IRIs.
...
- If the user does not specify a base IRI, use <urn:rdflib_reasoning:> for newly
  minted IRIs.
...
def evaluate_actual_graph(extracted_graph: Graph) -> tuple[dict, dict[str, Graph]]:
